...
export default function GameScreen({ difficulty, onBack }) {
    ...
    const [successDelay, setSuccessDelay] = useState('1.5');
                ...
                >
                    ...
                    >
                        <Pressable style={styles.settingsModal}>
                            ...
                            <View style={styles.settingsGroup}>
                                <Text style={styles.settingsLabel}>Success Delay (seconds)</Text>
                                <View style={styles.jumpContainer}>
                                    <TextInput
                                        style={styles.jumpInput}
                                        placeholder="Seconds..."
                                        ...
                                        onChangeText={(val) => {
                                            ...
                                            if (!isNaN(parseFloat(val))) {
                                                PuzzleManager.setSuccessDelay(val);
                                            }
                                        }}
                                    />
                                    <Text style={styles.jumpBtnText}>sec</Text>
                                </View>
                            </View>
