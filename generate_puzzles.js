...
const medium_raw = [
    ...
    { "problemid": 644, "type": "Mate in Two", "fen": "3r4/p1p4p/1pb3pk/4R3/2P3B1/2Q3PP/P2q1P2/6K1 w - - 0 1", "moves": "e5-h5;g6-h5;c3-f6" },
    { "problemid": 645, "type": "Mate in Two", "fen": "4n1bk/8/6PK/8/7N/8/8/8 w - - 0 1", "moves": "g6-g7;e8-g7;h4-g6" },
    { "problemid": 646, "type": "Mate in Two", "fen": "8/8/5r2/8/1Nb5/p7/4R3/k1K5 w - - 0 1", "moves": "e2-a2;c4-a2;b4-c2" },
    { "problemid": 647, "type": "Mate in Two", "fen": "8/8/B5b1/8/3N4/7r/p7/k1K4n w - - 0 1", "moves": "a6-d3;h1-f2;d4-c2" },
    { "problemid": 648, "type": "Mate in Two", "fen": "3r1k2/1p2p1b1/p5p1/q2B3R/3B1PP1/8/PPP5/2K4R w - - 0 1", "moves": "h5-h8;g7-h8;h1-h8" }
];
...
const hard_raw = [
    ...
    { "problemid": 4424, "type": "Mate in Three", "fen": "b7/k3bR1p/6p1/8/5P2/2Q3PK/6B1/rr6 b - - 0 1", "moves": "b1-h1;g2-h1;a1-h1;h3-g4;h7-h5" },
    { "problemid": 4425, "type": "Mate in Three", "fen": "qk3r2/2p5/8/3P4/2Q5/P5Pp/1P5P/5R1K b - - 0 1", "moves": "a8-d5;f1-f3;d5-f3;h1-g1;f3-g2" },
    { "problemid": 4426, "type": "Mate in Three", "fen": "Q7/5pkp/7r/4q3/6p1/5PP1/4n1KP/4RR2 b - - 0 1", "moves": "h6-h2;g2-h2;e5-g3;h2-h1;g3-h3" },
    { "problemid": 4427, "type": "Mate in Three", "fen": "5r1k/ppq1p3/4Q1p1/2P2r2/1P4n1/6Pb/P4P2/R2NR1KB b - - 0 1", "moves": "c7-g3;f2-g3;f5-f1;e1-f1;f8-f1" },
    { "problemid": 4428, "type": "Mate in Three", "fen": "3qk2r/1R1n1pp1/p1Qpp3/8/P2B1P2/5P2/5f2/5R1B b - - 0 1", "moves": "h8-h2;g2-h2;d8-h4;h2-g2;h4-g3" }
];

function formatMoves(moveStr) {
    return moveStr.split(';').map(m => m.replace('-', ''));
}

function getDifficulty(typeStr) {
    if (typeStr.includes("One")) return "easy";
    if (typeStr.includes("Two")) return "medium";
    return "hard";
}

const allPuzzles = [...easy_raw, ...medium_raw, ...hard_raw].map(p => ({
    id: p.problemid,
    fen: p.fen,
    difficulty: getDifficulty(p.type),
    description: (p.fen.includes(" w ") ? "White" : "Black") + " to move. " + p.type + ".",
    solution: formatMoves(p.moves)
}));
